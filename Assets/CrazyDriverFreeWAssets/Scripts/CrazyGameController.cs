...
namespace EndlessCarChase
{
	...
	/// </summary>
	public class CrazyGameController : MonoBehaviour 
	{
        ...
        //powerup
        public invincible invincibility;
        ...
        void Awake()
		{
            ...
            //GameObject.FindObjectOfType<CrazyShop>().gameObject.SetActive(true);
          //  if (shopMenu)
          //  {
                //Get the number of the current item
          //      shopMenu.currentItem = PlayerPrefs.GetInt(shopMenu.currentPlayerprefs, shopMenu.currentItem);
            ...
            //    playerObject = shopMenu.items[shopMenu.currentItem].itemIcon.GetComponent<CrazyCar>();
          //  }
		...
		void Start()
		{
          ...
          //  ChangeScore(0);
           ...
           // if ( shopMenu )    shopMenu.gameObject.SetActive(false);
            ...
            highScore = PlayerPrefs.GetInt(SceneManager.GetActiveScene().name + "HighScore_FW", 0);
        ...
        public void StartGame()
        {
            ...
            if (GetComponent<CrazySpawnAroundObject>()) GetComponent<CrazySpawnAroundObject>().isSpawning = true;
        ...
        void Update()
		{
			...
			else
			{
                ...
                if (score > highScore)
                {
                    ...
                    PlayerPrefs.SetInt(SceneManager.GetActiveScene().name + "HighScore_FW", highScore);
                }
        ...
        IEnumerator GameOver(float delay)
		{
            ...
            if ( gameOverCanvas )    
			{
				...
				if ( score > highScore )    
				{
					...
					//Register the new high score
					PlayerPrefs.SetInt(SceneManager.GetActiveScene().name + "HighScore_FW", score);
				}
				
				//Write the high sscore text
				gameOverCanvas.Find("Window/Content/Base/TextHighScore").GetComponent<Text>().text = "HIGH SCORE " + highScore.ToString();
