...
namespace EndlessCarChase
{
	...
	/// </summary>
	public class CrazyShop : MonoBehaviour 
	{
        // Hold the gamecontroller for quicker access
        internal CrazyGameController gameController;
        ...
        public void OnEnable()
        {
            ...
            if (speedMax == 0 && rotateSpeedMax == 0 && healthMax == 0 && damageMax == 0)
            {
                ...
                {
                    if (speedMax < items[index].itemIcon.GetComponent<CrazyCar>().speed) speedMax = items[index].itemIcon.GetComponent<CrazyCar>().speed;
                    if (rotateSpeedMax < items[index].itemIcon.GetComponent<CrazyCar>().rotateSpeed) rotateSpeedMax = items[index].itemIcon.GetComponent<CrazyCar>().rotateSpeed;
                    if (healthMax < items[index].itemIcon.GetComponent<CrazyCar>().health) healthMax = items[index].itemIcon.GetComponent<CrazyCar>().health;
                    if (damageMax < items[index].itemIcon.GetComponent<CrazyCar>().damage) damageMax = items[index].itemIcon.GetComponent<CrazyCar>().damage;
                }
            }
        ...
        void Start()
        {
            ...
            if (gameController == null) gameController = GameObject.FindObjectOfType<CrazyGameController>();
        ...
        public void ChangeItem( int changeValue )
        {
            ...
            if ( items[currentItem].itemIcon )
            {
                ...
                if ( currentIcon.GetComponent<CrazyCar>())
                {
                    // Fill values for the icons
                    if (transform.Find("Base/Stats/Speed/Full"))    transform.Find("Base/Stats/Speed/Full").GetComponent<Image>().fillAmount = currentIcon.GetComponent<CrazyCar>().speed/speedMax;
                    if (transform.Find("Base/Stats/RotateSpeed/Full")) transform.Find("Base/Stats/RotateSpeed/Full").GetComponent<Image>().fillAmount = currentIcon.GetComponent<CrazyCar>().rotateSpeed/rotateSpeedMax;
                    if (transform.Find("Base/Stats/Health/Full")) transform.Find("Base/Stats/Health/Full").GetComponent<Image>().fillAmount = currentIcon.GetComponent<CrazyCar>().health/healthMax;
                    if (transform.Find("Base/Stats/Damage/Full")) transform.Find("Base/Stats/Damage/Full").GetComponent<Image>().fillAmount = currentIcon.GetComponent<CrazyCar>().damage / damageMax;

                    // Text values inside the icons
                    if (transform.Find("Base/Stats/Speed/Text")) transform.Find("Base/Stats/Speed/Text").GetComponent<Text>().text = currentIcon.GetComponent<CrazyCar>().speed.ToString();
                    if (transform.Find("Base/Stats/RotateSpeed/Text")) transform.Find("Base/Stats/RotateSpeed/Text").GetComponent<Text>().text = currentIcon.GetComponent<CrazyCar>().rotateSpeed.ToString();
                    if (transform.Find("Base/Stats/Health/Text")) transform.Find("Base/Stats/Health/Text").GetComponent<Text>().text = currentIcon.GetComponent<CrazyCar>().health.ToString();
                    if (transform.Find("Base/Stats/Damage/Text")) transform.Find("Base/Stats/Damage/Text").GetComponent<Text>().text = currentIcon.GetComponent<CrazyCar>().damage.ToString();
                }
            }
        ...
        public void SelectItem()
        {
            ...
            if (items[currentItem].lockState == 1)
            {
                ...
                gameController.playerObject = items[currentItem].itemIcon.GetComponent<CrazyCar>();
